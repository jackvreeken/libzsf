...
double sal_psu_2_density(double sal_psu, double temperature)
{
    ...
    double a = (8.24493E-1 - 4.0899E-3 * temperature
                + 7.6438E-5 * pow(temperature, 2.0)
                - 8.2467E-7 * pow(temperature, 3.0)
                + 5.3875E-9 * pow(temperature, 4.0));
    double b = -5.72466E-3 + 1.0227E-4 * temperature - 1.6546E-6 * pow(temperature, 2.0);
    double c = 4.8314E-4;

    double rho_ref = (999.842594 + 6.793952E-2 * temperature
                      - 9.095290E-3 * pow(temperature, 2.0)
                      + 1.001685E-4 * pow(temperature, 3.0)
                      - 1.120083E-6 * pow(temperature, 4.0)
